    ...
    <div className="bg-white rounded-2xl p-5 border border-[#D6E1EA] hover:shadow-md transition-shadow">
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="text-[#536172] hover:text-[#061B35]">
      ...
      <div className="border-t border-[#D6E1EA] pt-4">
        {showDeleteConfirm ? (
          ...
          <div className="flex items-center gap-1 text-sm">
            <button className="px-3 py-2 text-[#06162E] hover:bg-[#EEF8FC] rounded-lg transition-colors flex items-center gap-1">
            ...
            <span className="text-[#D6E1EA]">•</span>
            <button className="px-3 py-2 text-[#06162E] hover:bg-[#EEF8FC] rounded-lg transition-colors">
              设为默认
            </button>
          </div>
        ) : (
